...
const (
	...
	// rbomcode: const rbom_level values
	rbom_level_intra_1_2 float32 = 1.0
	rbom_level_inter_1   float32 = 4.0
	rbom_level_inter_2   float32 = 7.0
...
func getTestConfigData() *beaconing.StaticInfoCfg {
	...
	return &beaconing.StaticInfoCfg{
		...
		// rbomcode: get rbom level data
		RbomLevel: map[iface.ID]beaconing.InterfaceRbomLevel{
			1: {
				Inter: rbom_level_inter_1,
				Intra: map[iface.ID]float32{
					2: rbom_level_intra_1_2,
				},
			},
			2: {
				Inter: rbom_level_inter_2,
				Intra: map[iface.ID]float32{
					1: rbom_level_intra_1_2,
				},
			},
		},
